...
export function WeeklyView() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', overflowY: 'auto' }}>
      ...
      {/* This week total */}
      <div style={{ padding: '10px 14px 6px', display: 'flex', alignItems: 'baseline', justifyContent: 'space-between' }}>
      ...
      {/* Divider */}
      <div style={{ borderTop: '1px solid rgba(255,255,255,0.06)', margin: '2px 14px 6px' }} />

      {/* Previous weeks label */}
      <div style={{ fontSize: 9, fontWeight: 700, letterSpacing: '0.08em', color: 'rgba(255,255,255,0.28)', textTransform: 'uppercase', padding: '0 14px 6px' }}>
        Previous weeks
      </div>
